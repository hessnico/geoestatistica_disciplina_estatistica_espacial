...
plot(vario.4, lwd=2)
```
# Variogramas com envelopes de Monte Carlo. O gráfico da esquerda faz envelopes baseados em permutações dos dados, isto é, nao faz supopsições de correlação espacial. O segundo gráfico é baseado em simulações dado um conjunto de parâmetros do modelo, no nosso caso, o modelo de máxima verossimilhança. Este envelope mostra a variabilidade do variograma impírico
